...
class dense121_mcs(nn.Module):
    ...
    def __init__(self, n_class, pretrained=True):
        ...
        A_model = DenseNet121_v0(n_class=n_class, pretrained=pretrained)
        self.featureA = A_model
        self.classA = A_model.densenet121.features

        B_model = DenseNet121_v0(n_class=n_class, pretrained=pretrained)
        self.featureB = B_model
        self.classB = B_model.densenet121.features

        C_model = DenseNet121_v0(n_class=n_class, pretrained=pretrained)
